...
def start_recording():
    ...
    MEMORY.insertData("pepper_recording_path", filepath)
    MEMORY.insertData("pepper_is_recording", True)
...
def stop_and_process():
    try:
        is_recording = MEMORY.getData("pepper_is_recording")
    except:
    ...
    filepath = MEMORY.getData("pepper_recording_path")
    try:
    ...
    try:
        os.remove(filepath)
        MEMORY.removeData("pepper_recording_path")
        MEMORY.removeData("pepper_is_recording")
