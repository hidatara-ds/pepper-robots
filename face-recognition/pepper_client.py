...
def main(session):
    ...
    time.sleep(1)
    save_path = "/home/nao/recognitionrdings/cameras/"
    ...
    # 2. Kirim ke endpoint /recognitiongnize
    url = BASE_URL + "/recognitiongnize"
    try:
