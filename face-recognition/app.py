...
@app.route('/recognitiongnize', methods=['POST'])
def recognitiongnize_face():
    """
    ...
    if file:
        ...
        try:
            ...
            if not dfs or dfs[0].empty:
                ...
                return jsonify({"status": "unrecognitiongnized", "message": UNRECOGNIZED_MESSAGE})
